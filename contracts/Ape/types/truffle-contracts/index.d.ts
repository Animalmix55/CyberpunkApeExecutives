...
import { CyberpunkApeExecutivesContract } from "./CyberpunkApeExecutives";
...
declare global {
  namespace Truffle {
    interface Artifacts {
      require(name: "CyberpunkApeExecutives"): CyberpunkApeExecutivesContract;
...
export {
  ...
  CyberpunkApeExecutivesInstance,
} from "./CyberpunkApeExecutives";
