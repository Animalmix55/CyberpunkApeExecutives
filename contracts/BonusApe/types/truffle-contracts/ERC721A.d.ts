...
export interface ERC721AContract extends Truffle.Contract<ERC721AInstance> {
  "new"(
    name_: string,
    symbol_: string,
    meta?: Truffle.TransactionDetails
  ): Promise<ERC721AInstance>;
}
...
export interface ERC721AInstance extends Truffle.ContractInstance {
  /**
